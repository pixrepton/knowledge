...
Status: current direction only. Last updated: 2026-08-28 (current closeout complete; Offer -> Case OS observability active).

## Current program (canonical)

**Plan kanoniczny:** `knowledge/docs/AI_OS_ROADMAP.md`.

**Current operator direction in this session:** the Cieplo/Fast-Kalk/gggggen closeout cycle is product-closed; GitHub publication is tracked separately if host policy blocks push. `Offer -> Case OS observability` is now the active product program. Do not open frontend staging in parallel.

```text
TASK_ENGINE_ACTIVE = 0
CIEPLO_PRODUCTION_REPAIR_20260826 = CLOSED / DEPLOYED / PROD_PROVEN
CIEPLO_INCIDENT_CHECKPOINT = CLOSED
AMP_RECOVERY = PASS
...
FAST_KALK_0_6_8 = DEPLOYED / PROVEN
FAST_KALK_832DEA8 = KEEP
FAST_KALK_MAIL_PROOF = DEFERRED_NO_SAFE_SINK
...
GGGGGEN_1_0_2_ASSET_ISOLATION = DEPLOYED / PROVEN
TOP_INSTALL_GENERATOR_LOCAL_CANONICAL = PASS / e79ab48c71544e5859ea10b3dcda13ef1a987344
CURRENT_OPERATOR_DIRECTION = OFFER_CASE_OS_OBSERVABILITY_ACTIVE
FAST_KALK_SCOPE_DIVERSION_COMMIT_832DEA8 = KEEP / DEPLOYED_PROVEN_IN_0_6_8
OFFER_CASE_OS_OBSERVABILITY_01 = ACTIVE / FIRST_VERTICAL_SLICE
