...
| **P3**    | Product quality | Fresh38 requalified (measurement) — now **11-CAPABILITY focused analysis** | Measurement green (38/38, 2026-08-16); baseline 27/38 CLEAN_PASS (v5, próg 34) below threshold; focused per-case proof before any product change |
