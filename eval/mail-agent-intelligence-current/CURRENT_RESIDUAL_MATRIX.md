...
| INT-04 | CLEAN_PASS | False | understanding next_step BORDERLINE | K3 | `EVALUATOR_GT_SCORER_SUSPECTED` | `ADJUDICATION_PENDING` — P3A frozen assembly required | NOT_PROVEN |
| NEW-05 | CLEAN_PASS | False | understanding next_step BORDERLINE | K3 | `EVALUATOR_GT_SCORER_SUSPECTED` | `ADJUDICATION_PENDING` — P3A frozen assembly required | NOT_PROVEN |
| FU-01 | CLEAN_PASS | False | understanding gaps BORDERLINE + minor escalation | K3 | `EVALUATOR_GT_SCORER_SUSPECTED` | `ADJUDICATION_PENDING` — P3A frozen assembly required | NOT_PROVEN |
| MI-01 | CLEAN_PASS | False | understanding gaps BORDERLINE | K3 | `EVALUATOR_GT_SCORER_SUSPECTED` | `ADJUDICATION_PENDING` — P3A frozen assembly required | NOT_PROVEN |
